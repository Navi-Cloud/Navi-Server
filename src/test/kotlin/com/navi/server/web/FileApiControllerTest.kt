...
class FileApiControllerTest {
    ...
    fun testFindAllDesc() {
        ...
        fileName.forEach {
            val id = fileRepository.save(FileEntity(fileName = it, fileType = "fileType", mimeType = "text/plain", token = "token", prevToken = "token", lastModifiedTime = "Time", fileCreatedDate = "testCreatedTime", fileSize = "5000"))
        }
        //send api request
